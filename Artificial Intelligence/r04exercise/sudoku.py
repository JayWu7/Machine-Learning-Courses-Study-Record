...
def atMost1(fmas):
    ...
    for i in range(length):
        for j in range(i + 1, length):
            new_fmas.append(NOT(AND([fmas[i], fmas[j]])))
    return AND(new_fmas)
...
def sudoku2fma(puzzle):
    ...
    C2 = AND([exactly1([S(c, r, n) for c in range(1, 10)]) for n in range(1, 10) for r in range(1, 10)])
    ### IMPLEMENT THIS ## IMPLEMENT THIS ## IMPLEMENT THIS ## IMPLEMENT THIS ###

    # Every column has all numbers
    C3 = AND([exactly1([S(c, r, n) for r in range(1, 10)]) for n in range(1, 10) for c in range(1, 10)])
    ### IMPLEMENT THIS ## IMPLEMENT THIS ## IMPLEMENT THIS ## IMPLEMENT THIS ###
    ...
    for i in [1, 4, 7]:
        for j in [1, 4, 7]:
            for n in range(1, 10):
                fomu.append(exactly1([S(c, r, n) for r in range(i, i + 3) for c in range(j, j + 3)]))
    C4 = AND(fomu)
    ### IMPLEMENT THIS ## IMPLEMENT THIS ## IMPLEMENT THIS ## IMPLEMENT THIS ###
